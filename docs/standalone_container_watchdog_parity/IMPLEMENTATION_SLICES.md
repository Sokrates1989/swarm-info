...
[single-manager Swarm](SCWP_03B_SWARM_REGRESSION.md) gates. `SCWP-03C` has also
passed its implementation, automated regression, disposable
[QNAP Compose transaction](SCWP_03C_QNAP_EVIDENCE.md), and
